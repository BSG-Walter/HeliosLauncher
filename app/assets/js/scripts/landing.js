...
const refreshServerStatus = async function(fade = false){
    ...
    try {
        ...
        loggerLanding.warn('No se pudo actualizar el estado del servidor, probablemente offline.')
        ...
        if(m.context === 'validateJava'){
                ...
                setDismissHandler(() => {
                    $('#overlayContent').fadeOut(250, () => {
                        ...
                        setOverlayContent(
                            ...
                            'Necesitas una version de 64 bits de Java 8 para jugar.<br><br>Por favor visita <a href="https://github.com/dscalzi/fuflauncher/wiki/Java-Management#manually-installing-a-valid-version-of-java">Java Management Guide</a> para obtener instrucciones de como instalar java.',
                            'Entiendo',
                            'Atrás'
                        )
                        setOverlayHandler(() => {
            ...
            if(m.result === true){
                ...
                setOverlayContent(
                    ...
                    'Desafortunadamente encontramos un error mientras se instalaba Java. Necesitaras instalarlo manualmente. Por favor visita nuestra <a href="https://github.com/dscalzi/fuflauncher/wiki">Guía de problemas</a> para mas detalles e instrucciones.',
                    'Entiendo'
                )
                setOverlayHandler(() => {
                    toggleOverlay(false)
...
function dlAsync(login = true){
    ...
    if(login) {
        if(ConfigManager.getSelectedAccount() == null){
            loggerLanding.error('Necesitas estar logeado en alguna cuenta.')
            return
        }
    }
    ...
    aEx.on('error', (err) => {
        ...
        showLaunchFailure('Error durante el lanzamiento', err.message || 'Abre la consola (CTRL + Shift + i) para mas detalles.')
    })
    aEx.on('close', (code, signal) => {
        if(code !== 0){
            loggerLaunchSuite.error(`AssetExec exited with code ${code}, assuming error.`)
            showLaunchFailure('Error durante el lanzamiento', 'Abre la consola (CTRL + Shift + i) para mas detalles.')
        }
    })
        ...
        if(m.context === 'validate'){
            switch(m.data){
                case 'distribution':
                    ...
                    setLaunchDetails('Cargando informacion de la version...')
                    break
                case 'version':
                    setLaunchPercentage(40, 100)
                    loggerLaunchSuite.log('Version data loaded.')
                    setLaunchDetails('Validando integridad de los recursos...')
                    break
                case 'assets':
                    setLaunchPercentage(60, 100)
                    loggerLaunchSuite.log('Asset Validation Complete')
                    setLaunchDetails('Validando integridad de las librerías...')
                    break
                case 'libraries':
            ...
            if(m.result.forgeData == null || m.result.versionData == null){
                ...
                showLaunchFailure('Error durante el lanzamiento', 'Por favor abre la consola (CTRL + Shift + i) para mas detalles.')
            ...
            if(login && allGood) {
                ...
                const onLoadComplete = () => {
                    toggleLaunchArea(false)
                    if(hasRPC){
                        DiscordWrapper.updateDetails('Cargando minecraft...')
                    }
                ...
                const gameStateChange = function(data){
                    ...
                    if(SERVER_JOINED_REGEX.test(data)){
                        ...
                        DiscordWrapper.updateDetails('Jugando NombreServer!')
                    }
                }
                ...
                const gameErrorListener = function(data){
                    ...
                    if(data.indexOf('Could not find or load main class net.minecraft.launchwrapper.Launch') > -1){
                        ...
                        showLaunchFailure('Error During Launch', 'The main file, LaunchWrapper, failed to download properly. As a result, the game cannot launch.<br><br>To fix this issue, temporarily turn off your antivirus software and launch the game again.<br><br>If you have time, please <a href="https://github.com/dscalzi/fuflauncher/issues">submit an issue</a> and let us know what antivirus software you use. We\'ll contact them and try to straighten things out.')
                    }
                }
                ...
                try {
                    ...
                    setLaunchDetails('Todo listo. disfruta del server!')
    ...
    refreshDistributionIndex(true, (data) => {
        ...
        refreshDistributionIndex(false, (data) => {
            ...
            loggerLaunchSuite.error('No se pudo recargar el archivo de distribución.', err)
            if(DistroManager.getDistribution() == null){
                showLaunchFailure('Error fatal', 'No se pudo cargar el archivo de distribución. Abre la consola (CTRL + Shift + i) para mas detalles.')
